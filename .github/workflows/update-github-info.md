...
2. Call the `web_fetch` tool (do not use shell commands like `curl`, `wget`, or Node `fetch`) to read https://github.blog/latest/, https://github.blog/changelog/, and https://awesome-copilot.github.com/workflows/.
